...
def main():
    ...
    for momento in range(min(n_momentos, args.max_rounds)):
        ...
        #2: Recibir matriz de pesos del maestro (TYPE = 'M')
        ...
        #5: Enviar pesos actualizados al maestro (TYPE = 'm')
